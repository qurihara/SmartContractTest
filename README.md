...
Faucetは「蛇口」です。開発用に、無価値な暗号通貨である「テストネット用POL」を蛇口から分けてもらいます。1回で0.2POLもらえます。1日1回くらいしかもらえないと思います。意外と枯渇しやすいのでなんとかしたいところ。（まとまった量のPOLをもらえるフォームもあるみたいなんですが、現時点で成功してません。）

https://faucet.polygon.technology/

（イーサリアムのテストネットのSepolia用の通貨もくれる蛇口があるのですが、こちらは本物のメインネット仮想通貨を少量持っていないと使えない制限があるみたいです。）
